###############
'''
An attempt at recreating the results Google achieved in a LSTM network
Original Google article can be found at arxiv.org/pdf/1506.05869v2.pdf
'''
###############
...
tf.app.flags.DEFINE_integer("in_vocab_size", 100000, "English vocabulary size.")
tf.app.flags.DEFINE_integer("out_vocab_size", 100000, "French vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "/home/mnortham/projects/LSTM/data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "/home/mnortham/projects/LSTM/data", "Training directory.")
...
def train():
#Trains model using OpenSubtitles dataset
